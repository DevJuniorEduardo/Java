...
public class EntradaDatos2 {
	public static void main(String[] args) {
		// Usando JOptionPane
		String nombreUsuario = showInputDialog("Ingrese su nombre:");
		...
		System.out.println("Te llamas " + nombreUsuario + " y este año cumples " + (edad + 1) + " años. Y tienes un salario de " + salario + " pesos.");
	}
}